...
> **Important update:** This project has been updated for the **Artix-7 XC7A100T** version, including **IP upgrades** and **regenerated build targets**. It was successfully compiled on **Ubuntu MATE 24.04.4 LTS** using **Vivado ML Standard Edition 2024.1**.
